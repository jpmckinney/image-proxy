...
var express = require('express')
  ...
  , s3UploadService = require('../src/s3/service/s3-upload-service')
...
module.exports = function () {
  app.get('/:url', function (req, res, next) {
    ...
    retrieveRemote(res, next, 'http://s3.amazonaws.com/qmerce-static-media/' + req.params.url, null, null, null);
  });
...
//    return cutiecapt.capture(url, image_path, s3UploadService);
  });
